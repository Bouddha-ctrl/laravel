...
class ApiController extends Controller
{
    ...
    public function barre($country)
    {
        ...
        $Tcountry=$countries[$country][0];
        
        $country = str_replace(" ","%20",$country);

        $url = 'https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/country-report-iso-based/'.$country.'/'.$Tcountry;
        //echo $url;
        $curl = curl_init();
