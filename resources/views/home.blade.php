...
Ce chiffre est toutefois sous-estimé, car deux grands pays, la Chine et la Russie, n’ont pas communiqué de nouvelles données depuis une dizaine de jours....</p>
                    <div class="main-button">
                        <a target="_blank" href="https://www.ouest-france.fr/sante/vaccin/covid-19-plus-de-200-millions-de-doses-de-vaccins-ont-ete-administrees-dans-le-monde-7161766">Lire la suite</a>
                    </div>
                  </article>
                  <article id='tabs-2'>
                  <img src="{{asset('/frontend/images/vaccin2.jpg')}}" alt="">
                  <h4>La Russie enregistre un troisième vaccin contre le coronavirus.</h4>
                    <p><i class="fa fa-user"></i> Anis Kamal &nbsp;|&nbsp; <i class="fa fa-calendar"></i> 20.02.2021 14:15 &nbsp;|&nbsp; <i class="fa fa-comments"></i>  15 comments</p>
                    ...
                    <div class="main-button">
                        <a href="https://www.ouest-france.fr/europe/russie/covid-19-la-russie-enregistre-un-troisieme-vaccin-contre-le-coronavirus-7161685">Lire la suite</a>
                    </div>
                  </article>
                  <article id='tabs-3'>
                  <img src="{{asset('/frontend/images/vaccin3.jpg')}}" alt="">
                    ...
                    <div class="main-button">
                        <a href="https://www.sante.gov.ma/pages/actualites.aspx?IDActu=431">Lire la suite</a>
                    </div>
                  </article>
                </section>
              </div>
